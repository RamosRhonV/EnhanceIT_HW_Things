...
enum Language1: String, Codable {
    case eng = "eng"
}

// MARK: - EsrbRating
struct EsrbRating1: Codable {
    let id: Int
    let name, slug: String
}

// MARK: - ParentPlatform
struct ParentPlatform1: Codable {
    let platform: EsrbRating
}

// MARK: - PlatformElement
struct PlatformElement1: Codable {
    let platform: PlatformPlatform1
    let releasedAt: String
    let requirements: Requirements1
...
struct PlatformPlatform1: Codable {
    let id: Int
    let name, slug: String
    let image, yearEnd, yearStart: JSONNull1?
    let gamesCount: Int
    let imageBackground: String
...
// MARK: - Requirements
struct Requirements1: Codable {
    let minimum: String?
}

// MARK: - Rating
struct Rating1: Codable {
    let id: Int
    let title: String
    let count: Int
    let percent: Double
