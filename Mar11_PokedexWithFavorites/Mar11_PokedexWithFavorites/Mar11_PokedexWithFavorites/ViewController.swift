...
class ViewController: UIViewController {
    ...
    let favView = FavoritesViewController()
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.PokemonNameTextLabel.text = pokemon[indexPath.row].name.capitalized
        ...
        cell.PokemonTypeTextLabel.loadLabel(fromURL: pokeURL)
    
        // adds a button to the accessory view
    ...
    func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        ...
        //let favs = FavoritesViewController()
        favView.createFav(pokeNum: indexPath.row)
    }
